...
/// Parent home page mounted at `/parent`. Thin orchestrator —
/// each section is a self-contained widget under `widgets/`. This
/// file is intentionally short so additions stay localised to the
...
class ParentShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ParentResponsiveScaffold(
      ...
      body: _DashboardBody(firstName: firstName),
    );
  }
}
